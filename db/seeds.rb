...
PSpace1 = Space.create! name: "iX House", category: "Room", description: "Our conference room is great for meetings!", location: "19 Park Street, Gardens, Cape Town, South Africa", price: 200, capacity: 30, user: Peter, photo: "http://ventureburn.com/wp-content/uploads/2015/01/iX-Inside-corridor.jpg"
PSpace2 = Space.create! name: "Once", category: "Outdoor Area", description: "Choose us for your backyard braai! Full-size fireplace + small grill + full-size kitchen.", location: "73 Kloof Street, Gardens, Cape Town, South Africa", price: 300, capacity: 40, user: Peter, photo: "https://www.travelground.com/blog/wp-content/uploads/2014/06/once-in-cape-town-exterior.jpg"
PSpace3 = Space.create! name: "International School of Cape Town", category: "Room", description: "After hours, our classrooms can be used for everything from workshops to art studio space", location: "Woodland Heights, Edinburgh Close, Wynberg 7806, Cape Town, South Africa", price: 100, capacity: 30, user: Peter, photo: "http://schools-sa.co.za/images/1d3e37f77f77fb1aebeb3dc9675bee64.jpg"
PSpace4 = Space.create! name: "Yours Truly", category: "Display", description: "Our walls would be perfect for displaying local artists' work.", location: "73 Kloof Street, Gardens, Cape Town, South Africa", price: 20, capacity: 1, user: Peter, photo: "http://elledecoration.co.za/wp-content/uploads/2011/01/Yourstruly1.jpg"


TSpace1 = Space.create! name: "Mzansi's", category: "Room", description: "We're a family-owned restaurant in the heart of Langa, and we're passionate about supporting local musicians", location: "45 Harlem Ave, Langa, Cape Town, 7455", price: 20, capacity: 20, user: Tracy, photo: "http://oncebitten.co.za/wp-content/uploads/2010/06/Nomode-Siyaka-of-Mzansi-restaurant-in-Langa.jpg"
TSpace2 = Space.create! name: "Community Center", category: "Building", description: "Flexible space that includes and ampitheater, ceramics facilities, and a gathering space.", location: "Langa, Cape Town", price: 150, capacity: 60, user: Tracy, photo: "http://media-cdn.tripadvisor.com/media/photo-s/03/a1/a9/0a/langa-township.jpg"
...
SEvent1 = Event.create! name: "Weekly Yoga Class", location: "Cape Town", people: 15, category: "Workshop/Class", description: "Join me for yoga at the end of a long week to help destress", public: true, user: Sally, date: DateTime.parse("2/8/2015 17:00"), space: PSpace3, photo: "http://www.theslimhour.com/uploads/3/8/8/3/3883923/6202620_orig.jpg"
SEvent2 = Event.create! name: "Ray's 21st Birthday!", location: "Cape Town", people: 25, category: "Gathering", description: "I'm throwing my friend Ray a surprise birthday party... she doesnt have internet so she wont know", public: false, user: Sally, date: DateTime.parse("10/8/2015 17:00"), space: PSpace3, photo: "http://www.freedom-center.com/wp-content/uploads/birthday2.jpg"
SEvent3 = Event.create! name: "Art Studio Hours", location: "Cape Town", people: 1, category: "Personal", description: "Looking for a space to finish some art pieces and do artsy stuff", public: false, user: Sally, date: DateTime.parse("11/8/2015 17:00"), space: PSpace3, photo: "http://interiordesignids.com/images/good-art-studio-decorating-ideas-5-art-studio.jpg"
SEvent4 = Event.create! name: "Volunteers4Change", location: "Cape Town", people: 50, category: "Gathering", description: "I want to bring together local volunteers to knit scarves for shelters", public: true, user: Sally, date: DateTime.parse("11/8/2015 17:00"), photo: "http://www.capetown.travel/cache/ce_cache/made/cache/ce_cache/remote/http_vmmsportal.capetown.travel/Shared/Images/245672/2_640_480_80.jpg"

HEvent1 = Event.create! name: "Going Away Party", location: "Joburg", people: 50, category: "Gathering", description: "Celebration for my best friend's going away. She's moving all the way to Cambodia! It's crazy!", public: false, user: Harry, date: DateTime.parse("15/8/2015 17:00"), space: PSpace3
HEvent2 = Event.create! name: "Entrepreneur Workshop", location: "Cape Town", people: 20, category: "Workshop/Class", description: "A workshop to help budding entrepreneurs. Come join and learn about how you can expand or start your own business", public: true, user: Harry, date: DateTime.parse("12/8/2015 17:00"), space: PSpace3, photo: "http://blog.operationhope.org/wp-content/uploads/2012/10/FALL-ETP-2012-Oak.jpg"
HEvent3 = Event.create! name: "Slam Poetry Performance", location: "Cape Town", people: 100, category: "Performance", description: "Come see UCT students perform original slap poetry", public: true, user: Harry, date: DateTime.parse("20/8/2015 17:00"), space: PSpace3, photo: "http://www.csmonitor.com/var/ezflow_site/storage/images/media/images/2010/0628-weekly/0628-lslam-02-poetry-slam-poet/8156842-1-eng-US/0628-LSLAM-02-poetry-slam-poet_full_600.jpg"
